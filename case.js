...
case 'enc': {
        ...
        break
case 'bott': case 'bot?': case 'list': case 'menu': case 'bot': case 'elisa': {
            if (!isRegistered) return replygcxeon('Kamu belum daftar!\nSilahkan daftar dengan cara *.daftar nama|umur!*')
	        let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let timestampe = speed();
            let latensie = speed() - timestampe
            xeonezy = `  *Hallo Kak @${sender.split("@")[0]} 👋.*
Saya adalah Queen Elisa, yaitu bot WhatsApp Multi Device ada yang bisa elisa bantu? elisa senang sekali jika membantu semua orang. ohw iya jan lupa baca rules elisa yah

]─────[ *RULES QUEEN ELISA* ]─────[
⬤ *JANGAN TELPON BOT!!*
⬤ *JANGAN TELPON OWNER BOT!!*
⬤ *JANGAN SPAM BOT!!*
⬤ *JANGAN BANDINGKAN BOT!!!!*
⬤ *JANGAN CULIK BOT!!!*

Untuk menampilkan menu silahkan ketik *.allmenu*
...
*Namaku Queen Elisa, yaitu Bot WhatsApp Multi Device*
...
╭────────────────✾
●${prefix}glitchtext  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}writetext  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}advancedglow  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}typographytext  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}pixelglitch  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}neonglitch  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}flagtext  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}flag3dtext  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}deletingtext  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}blackpinkstyle  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}glowingtext  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}underwatertext  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}logomaker  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}cartoonstyle  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}papercutstyle  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}watercolortext  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}effectclouds  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}blackpinklogo  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}gradienttext  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}summerbeach  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}luxurygold  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}multicoloredneon  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}sandsummer  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}galaxywallpaper  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}1917style  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}makingneon  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}royaltext  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}freecreate  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}galaxystyle  *ᴘʀᴇᴍɪᴜᴍ*
●${prefix}lighteffects  *ᴘʀᴇᴍɪᴜᴍ*
╰────────────────✾
...
┌ ◦ ${prefix}antilinkgc  *ɢʀᴏᴜᴘ*
々 ${prefix}antiwame  *ɢʀᴏᴜᴘ*
々 ${prefix}antilinkall  *ɢʀᴏᴜᴘ*
々 ${prefix}antilinktiktok  *ɢʀᴏᴜᴘ*
々 ${prefix}antilinkfb  *ɢʀᴏᴜᴘ*
々 ${prefix}antilinktwitter  *ɢʀᴏᴜᴘ*
々 ${prefix}antilinkig  *ɢʀᴏᴜᴘ*
々 ${prefix}antilinktg  *ɢʀᴏᴜᴘ*
々 ${prefix}antilinkytvid  *ɢʀᴏᴜᴘ*
々 ${prefix}antilinkytch  *ɢʀᴏᴜᴘ*
々 ${prefix}antivirus  *ɢʀᴏᴜᴘ*
々 ${prefix}antitoxic  *ɢʀᴏᴜᴘ*
々 ${prefix}antilink  *ɢʀᴏᴜᴘ*
└ ◦ ${prefix}antiwame  *ɢʀᴏᴜᴘ*
...
┌ ◦ ${prefix}self  *ᴏᴡɴᴇʀ*
々 ${prefix}public  *ᴏᴡɴᴇʀ*
々 ${prefix}join  *ᴏᴡɴᴇʀ*
々 ${prefix}bctext  *ᴏᴡɴᴇʀ*
々 ${prefix}bcimage  *ᴏᴡɴᴇʀ*
々 ${prefix}bcvideo  *ᴏᴡɴᴇʀ*
々 ${prefix}creategc  *ᴏᴡɴᴇʀ*
々 ${prefix}setexif  *ᴏᴡɴᴇʀ*
々 ${prefix}shutdown  *ᴏᴡɴᴇʀ*
々 ${prefix}autostickergc  *ᴏᴡɴᴇʀ*
々 ${prefix}setppbot  *ᴏᴡɴᴇʀ*
々 ${prefix}addprem  *ᴏᴡɴᴇʀ*
々 ${prefix}delprem  *ᴏᴡɴᴇʀ*
々 ${prefix}addowner  *ᴏᴡɴᴇʀ*
々 ${prefix}delowner  *ᴏᴡɴᴇʀ*
々 ${prefix}addvn  *ᴏᴡɴᴇʀ*
々 ${prefix}delvn  *ᴏᴡɴᴇʀ*
々 ${prefix}addsticker  *ᴏᴡɴᴇʀ*
々 ${prefix}delsticker  *ᴏᴡɴᴇʀ*
々 ${prefix}addimage  *ᴏᴡɴᴇʀ*
々 ${prefix}delimage  *ᴏᴡɴᴇʀ*
々 ${prefix}addvideo  *ᴏᴡɴᴇʀ*
々 ${prefix}delvideo  *ᴏᴡɴᴇʀ*
々 ${prefix}block add  *ᴏᴡɴᴇʀ*
々 ${prefix}unblock del  *ᴏᴡɴᴇʀ*
└ ◦ ${prefix}leavegc  *ᴏᴡɴᴇʀ*
